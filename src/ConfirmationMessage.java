...
//    String BN = Borrowing.bookName;
//    String T = availableTimes.time;
    ...
    public ConfirmationMessage() {
        ...
        jTextField1.setText(BorrowingGUI.chosenBook.getTitle());
        jTextField2.setText(availableTimes.time);
        int n = Login.currentlyCustomer.getNum_currentlyBorrowedBooks();
        jTextField3.setText(Integer.toString(n));
    }
    
    public ConfirmationMessage(String name, String period) {
        this();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Borrowed successfully");
        ...
        jLabel4.setText("Number of your currently borrowed books:");
